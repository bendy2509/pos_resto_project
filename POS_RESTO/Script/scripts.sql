...
CREATE DATABASE IF NOT EXISTS posresto 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

-- 2. Creation de l'utilisateur administrateur
CREATE USER 'pos_resto_admin'@'localhost' IDENTIFIED BY 'Servilus_2509@';

-- 3. Attribution des droits sur la base posresto
...
-- Trigger 2 : Mise à jour de la dette client après paiement
...
BEGIN
    ...
    -- On recupère les details de la commande liee au paiement
    ...
    -- Securite : Empêcher une dette negative
    UPDATE Clients SET debt_amount = 0 
    WHERE client_id = v_client_id AND debt_amount < 0;
END //
